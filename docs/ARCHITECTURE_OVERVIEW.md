...
> الإصدار: 2.8.86 | تاريخ التحديث: 2025-12-11
...
```
src/
├── components/          # مكونات UI (44+ مجلد)
├── hooks/              # Hooks (25 مجلد فرعي)
│   ├── accounting/     # محاسبة
│   ├── auth/           # مصادقة
...
ملف `src/lib/query-keys.ts` يحتوي على **340+ مفتاح** موحد لجميع استعلامات React Query:
...
|---------|-------|
| إجمالي الخدمات | 51+ |
| إجمالي الـ Hooks | 170+ |
| مجلدات الـ Hooks | 25 |
| مفاتيح QUERY_KEYS | 340+ |
| أنواع `any` | 7 (مبررة) |
| تغطية RLS | 100% |
