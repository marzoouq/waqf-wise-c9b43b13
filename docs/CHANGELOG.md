...
**الإصدار الحالي:** 2.9.12 | **آخر تحديث:** 2025-12-14
...
| الملف | الوصف |
|-------|-------|
| `src/contexts/UsersDialogsContext.tsx` | سياق منفصل لإدارة حالة الحوارات |
| `src/components/users/UsersTableSkeleton.tsx` | Skeleton Loading لجدول المستخدمين |
| `src/utils/governance-pdf.ts` | توليد PDF للائحة التنفيذية |
| `src/hooks/governance/useRegulationsSearch.ts` | Hook للبحث في اللائحة |
| `src/components/governance/RegulationsSearchBar.tsx` | شريط البحث في اللائحة |

#### ✅ تحسينات المستخدمين
| المشكلة | الحل |
|---------|------|
| تكرار منطق الحذف | توحيد في Users.tsx مع التحقق في مكان واحد |
| Dialog State خارج Context | نقل لـ UsersDialogsContext منفصل |
| عدم وجود Skeleton Loading | إضافة UsersTableSkeleton |

#### ✅ تحسينات الحوكمة
| الميزة | الوصف |
|--------|-------|
| تحميل PDF | زر تحميل يعمل فعلياً |
| بحث متقدم | بحث في 17 جزء و 22 فصل |
| تمييز النتائج | Highlight للنص المطابق |

#### 📊 نتائج التحسين
- تقليل props drilling بنسبة 100%
- Skeleton Loading لتجربة مستخدم أفضل
- Dialog State مركزي في Context منفصل
- بحث فوري في اللائحة التنفيذية
- تصدير PDF كامل للائحة
...
- دعم الانتقال للصفحة الأولى والأخيرة
