...
export class PropertyService {
   ...
   * جلب تنبيهات العقار
   */
  static async getAlerts(propertyId?: string): Promise<{ id: string; property_id: string | null; alert_type: string; title: string; message: string; severity: string; is_resolved: boolean; created_at: string }[]> {
    try {
      let query = supabase
