...
import { ArrowLeft, ArrowRight, Clock, User, Database, FileText, Copy, Check } from 'lucide-react';
    ...
    <div className="py-2 border-b border-border/50 last:border-0">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        >
          ...
          <div className="text-foreground">{formatValue(oldValue)}</div>
        </div>
        {/* القيمة الجديدة */}
        <div
          className={cn(
        ...
        >
          ...
          <div className="text-foreground">{formatValue(newValue)}</div>
        </div>
      </div>
    </div>
  );
        ...
        <ScrollArea className="flex-1 -mx-6 px-6">
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-3 flex-wrap">
              ...
              {log.user_role && <Badge variant="outline">الدور: {log.user_role}</Badge>}
              {log.record_id && (
