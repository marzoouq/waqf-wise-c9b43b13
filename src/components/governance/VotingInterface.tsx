...
import { ThumbsUp, ThumbsDown, Minus, Users, CheckCircle2 } from 'lucide-react';
      ...
      <CardContent className="space-y-6">
        ...
        {hasVoted && userVote && (
          <div className="bg-success-light border border-success/30 rounded-lg p-4">
            <p className="text-sm font-medium text-success">✅ تم تسجيل صوتك بنجاح</p>
            <div className="mt-2">
              <p className="text-sm text-success/80 mt-2">السبب: {userVote.vote_reason}</p>
            </div>
          </div>
        )}
        ...
        {!canVote && (
          <div className="bg-warning-light border border-warning/30 rounded-lg p-4">
            <p className="text-sm text-warning">ℹ️ ليس لديك صلاحية التصويت على هذا القرار</p>
          </div>
        )}
      </CardContent>
    </Card>
