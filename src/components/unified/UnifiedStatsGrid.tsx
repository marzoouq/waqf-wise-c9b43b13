 ...
 */
export function UnifiedStatsGrid({ children, columns = 4, className }: UnifiedStatsGridProps) {
  ...
  return <div className={cn('grid gap-4 sm:gap-6', getGridClasses(), className)}>{children}</div>;
}
