...
describe('UnifiedKPICard Component', () => {
  it('should render title and numeric value', () => {
    render(<UnifiedKPICard title="إجمالي المستفيدين" value={150} icon={Users} />);
  ...
  it('should render title and string value', () => {
    render(<UnifiedKPICard title="إجمالي الإيرادات" value="1,500,000 ر.س" icon={DollarSign} />);
  ...
  it('should display subtitle when provided', () => {
    render(<UnifiedKPICard title="العدد الإجمالي" value={100} subtitle="هذا الشهر" icon={Users} />);

    expect(screen.getByText('هذا الشهر')).toBeInTheDocument();
  });

  it('should display icon', () => {
    const { container } = render(<UnifiedKPICard title="Test" value={100} icon={Users} />);
  ...
  it('should show trend indicator with up direction', () => {
    render(<UnifiedKPICard title="النمو" value={100} icon={Users} trend="up" trendValue="+12%" />);
  ...
  it('should show trend indicator with down direction', () => {
    render(
      <UnifiedKPICard title="الانخفاض" value={100} icon={Users} trend="down" trendValue="-5%" />
    );
  ...
  it('should show trend as string directly', () => {
    render(<UnifiedKPICard title="التغيير" value={100} icon={Users} trend="+15%" />);
  ...
  it('should apply primary variant', () => {
    const { container } = render(
      <UnifiedKPICard title="Test" value={100} icon={Users} variant="primary" />
    );
  ...
  it('should apply success variant', () => {
    const { container } = render(
      <UnifiedKPICard title="Test" value={100} icon={Users} variant="success" />
    );
  ...
  it('should apply warning variant', () => {
    const { container } = render(
      <UnifiedKPICard title="Test" value={100} icon={Users} variant="warning" />
    );
  ...
  it('should apply destructive variant', () => {
    const { container } = render(
      <UnifiedKPICard title="Test" value={100} icon={Users} variant="destructive" />
    );
  ...
  it('should render in compact size', () => {
    const { container } = render(
      <UnifiedKPICard title="Test" value={100} icon={Users} size="compact" />
    );
  ...
  it('should render in large size', () => {
    render(<UnifiedKPICard title="Test" value={100} icon={Users} size="large" />);
  ...
  it('should show loading skeleton when loading is true', () => {
    const { container } = render(
      <UnifiedKPICard title="Test" value={100} icon={Users} loading={true} />
    );
  ...
  it('should handle click events when onClick is provided', async () => {
    ...
    render(<UnifiedKPICard title="Clickable" value={100} icon={Users} onClick={handleClick} />);
  ...
  it('should handle neutral trend', () => {
    render(
      <UnifiedKPICard title="Stable" value={100} icon={Users} trend="neutral" trendValue="0%" />
    );
  ...
  it('should render without subtitle', () => {
    render(<UnifiedKPICard title="Simple Card" value={100} icon={Users} />);
  ...
  it('should render without trend', () => {
    render(<UnifiedKPICard title="No Trend" value={100} icon={Users} />);
