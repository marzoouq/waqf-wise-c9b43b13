...
export function AttachmentsDialog({
  ...
  const { attachments, isLoading, uploadAttachment, deleteAttachment } =
      ...
      >
        <div className="space-y-4">
            ...
            <div className="border rounded-lg p-4 space-y-4">
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                <Button
                  ...
                  disabled={!selectedFile || !formData.file_type}
          ...
          {isLoading ? (
            ...
            <div className="text-center py-8 text-muted-foreground">لا توجد مرفقات مسجلة</div>
          ) : (
