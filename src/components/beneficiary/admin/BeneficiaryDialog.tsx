...
const beneficiarySchema = z.object({
  ...
  category: z.string().min(1, { message: 'الرجاء اختيار فئة المستفيد' }),
...
const BeneficiaryDialog = ({ open, onOpenChange, beneficiary, onSave }: BeneficiaryDialogProps) => {
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-sm font-medium">العائلة</FormLabel>
                    <FormControl>
                      <Input placeholder="مثال: عائلة العلي" {...field} className="text-right" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-sm font-medium">البريد الإلكتروني (اختياري)</FormLabel>
                  <FormControl>
                    <Input
                      type="email"
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-sm font-medium">نوع المستفيد</FormLabel>
                    <Select onValueChange={field.onChange} value={field.value}>
                      <FormControl>
                        <SelectTrigger className="text-right">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-sm font-medium">صلة القرابة</FormLabel>
                  <FormControl>
                    <Input placeholder="مثال: ابن، زوجة، أخ" {...field} className="text-right" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-sm font-medium">عدد الأبناء</FormLabel>
                    <FormControl>
                      <Input
                        type="number"
                        min="0"
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-sm font-medium">عدد البنات</FormLabel>
                    <FormControl>
                      <Input
                        type="number"
                        min="0"
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-sm font-medium">عدد الزوجات</FormLabel>
                    <FormControl>
                      <Input
                        type="number"
                        min="0"
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-sm font-medium">الحالة الوظيفية</FormLabel>
                    <Select onValueChange={field.onChange} value={field.value}>
                      <FormControl>
                        <SelectTrigger className="text-right">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-sm font-medium">نوع السكن</FormLabel>
                    <Select onValueChange={field.onChange} value={field.value}>
                      <FormControl>
                        <SelectTrigger className="text-right">
