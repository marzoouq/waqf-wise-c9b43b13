...
export function AdvancedSearchDialog({ open, onOpenChange, onSearch }: AdvancedSearchDialogProps) {
  ...
  return (
    <ResponsiveDialog open={open} onOpenChange={onOpenChange} title="البحث المتقدم" size="xl">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 py-4">
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={(value) =>
              setCriteria({ ...criteria, category: value === 'all' ? '' : value })
            }
          >
            <SelectTrigger>
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={(value) =>
              setCriteria({ ...criteria, status: value === 'all' ? '' : value })
            }
          >
            <SelectTrigger>
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={(value) =>
              setCriteria({ ...criteria, priorityLevel: value === 'all' ? '' : value })
            }
          >
            <SelectTrigger>
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={(value) =>
              setCriteria({ ...criteria, gender: value === 'all' ? '' : value })
            }
          >
            <SelectTrigger>
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={(value) =>
              setCriteria({ ...criteria, maritalStatus: value === 'all' ? '' : value })
            }
          >
            <SelectTrigger>
              <SelectValue placeholder="اختر الحالة" />
