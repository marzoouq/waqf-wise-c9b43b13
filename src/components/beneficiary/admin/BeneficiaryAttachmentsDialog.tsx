...
export function BeneficiaryAttachmentsDialog({
  ...
  const { attachments: existingAttachments, isLoading } = useBeneficiaryAttachments(
    beneficiary?.id
  );
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>إدارة وعرض المستندات والمرفقات الخاصة بالمستفيد</DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            {isLoading ? (
              ...
              <div className="text-center text-muted-foreground py-8">لا توجد مرفقات</div>
            )}
          </div>
        </div>
