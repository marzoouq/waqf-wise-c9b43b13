        ...
        <CardContent className="space-y-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              يمتلك الوقف {summary?.propertiesCount} عقار متنوع بين سكني وتجاري وزراعي، بقيمة
              إجمالية تقديرية تبلغ{' '}
              <MaskedValue
                value={summary?.totalPropertyValue.toLocaleString('ar-SA')}
                type="amount"
                masked={settings?.mask_exact_amounts || false}
          ...
          {settings?.show_total_beneficiaries_count && (
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                يستفيد من الوقف حالياً {summary?.beneficiariesCount} مستفيد نشط من مختلف الفئات
                والأولويات.
              </p>
            </div>
          )}
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              يتم استقطاع نسبة من عوائد الوقف للصيانة والتطوير وبناء احتياطي استراتيجي لضمان استدامة
              الوقف.
            </p>
          </div>
        </CardContent>
