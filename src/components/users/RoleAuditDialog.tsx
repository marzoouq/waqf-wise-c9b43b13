...
export function RoleAuditDialog({ open, onOpenChange, auditLogs }: RoleAuditDialogProps) {
  return (
    <ResponsiveDialog open={open} onOpenChange={onOpenChange} title="سجل تغييرات الأدوار" size="lg">
