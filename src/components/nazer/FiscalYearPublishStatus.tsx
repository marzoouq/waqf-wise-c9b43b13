...
export function FiscalYearPublishStatus({ onPublishClick }: FiscalYearPublishStatusProps) {
          ...
          <div className="flex items-center gap-3">
            <div
              className={`p-2 rounded-full ${
                activeFiscalYear.is_published ? 'bg-status-success/10' : 'bg-status-warning/10'
              }`}
            >
