      ...
      <Card>
        ...
        <CardContent>
          {!agingData || agingData.length === 0 ? (
            <div className="text-center py-8 text-muted-foreground">لا توجد قروض متأخرة</div>
          ) : isMobile ? (
            // Mobile Card View
              ...
              {agingData.map((loan) => (
                <Card key={loan.loan_id} className="p-3">
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <Badge
                      variant={
                        loan.aging_category.includes('خطير')
                          ? 'destructive'
                          : loan.aging_category.includes('متأخر جداً')
                            ? 'destructive'
                            : loan.aging_category.includes('متأخر')
                              ? 'default'
                              : 'secondary'
                      }
                    >
                  ...
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-bold">
                        {loan.remaining_balance.toLocaleString('ar-SA')} ريال
                      </span>
                    </div>
                  </div>
                  ...
                  {agingData.map((loan) => (
                    <TableRow key={loan.loan_id}>
                      ...
                      <TableCell className="text-xs sm:text-sm whitespace-nowrap">
                        {loan.principal_amount.toLocaleString('ar-SA')} ريال
                      </TableCell>
