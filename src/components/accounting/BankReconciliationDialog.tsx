...
export function BankReconciliationDialog({ open, onOpenChange }: BankReconciliationDialogProps) {
  ...
  return (
    <ResponsiveDialog open={open} onOpenChange={onOpenChange} title="التسوية البنكية" size="xl">
      {step === 'select' && (
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setNewStatement({ ...newStatement, bank_account_id: value })
                }
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  setNewStatement({ ...newStatement, statement_date: e.target.value })
                }
              />
            </div>
              ...
              <TableBody>
                {statements.map((statement) => (
                  <TableRow key={statement.id}>
                    ...
                    <TableCell>
                      {statement.bank_accounts?.bank_name} -{' '}
                      {statement.bank_accounts?.account_number}
                    </TableCell>
