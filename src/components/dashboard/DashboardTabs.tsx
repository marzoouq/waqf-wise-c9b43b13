...
const AdminActivities = lazy(() =>
  import('@/components/dashboard/admin/AdminActivities').then((m) => ({
    default: m.AdminActivities,
  }))
);
const AdminTasks = lazy(() =>
  import('@/components/dashboard/admin/AdminTasks').then((m) => ({ default: m.AdminTasks }))
);
const QuickActions = lazy(() =>
  import('@/components/dashboard/admin/QuickActions').then((m) => ({ default: m.QuickActions }))
);
...
const IntegratedReportsWidget = lazy(() =>
  import('@/components/dashboard/IntegratedReportsWidget').then((m) => ({
    default: m.IntegratedReportsWidget,
  }))
);
...
const AccountDistributionChart = lazy(
  () => import('@/components/dashboard/AccountDistributionChart')
);
...
const VouchersStatsCard = lazy(() =>
  import('@/components/dashboard/VouchersStatsCard').then((m) => ({ default: m.VouchersStatsCard }))
);
const PropertyStatsCard = lazy(() =>
  import('@/components/dashboard/PropertyStatsCard').then((m) => ({ default: m.PropertyStatsCard }))
);
const ExpiringContractsCard = lazy(() =>
  import('@/components/dashboard/ExpiringContractsCard').then((m) => ({
    default: m.ExpiringContractsCard,
  }))
);
const UpcomingPaymentsCard = lazy(() =>
  import('@/components/dashboard/UpcomingPaymentsCard').then((m) => ({
    default: m.UpcomingPaymentsCard,
  }))
);
