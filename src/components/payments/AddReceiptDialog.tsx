...
export function AddReceiptDialog({ open, onOpenChange }: AddReceiptDialogProps) {
  ...
  const form = useForm<ReceiptFormValues>({
    ...
    defaultValues: {
      payment_number: `RCP-${format(new Date(), "yyMMdd")}-001`,
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input {...field} placeholder="RCP-250115-001" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input {...field} placeholder="أدخل اسم الدافع" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input {...field} placeholder="وصف المقبوض" />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
