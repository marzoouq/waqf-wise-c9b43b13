...
const HEIR_COLORS = ['hsl(var(--primary))', 'hsl(var(--chart-2))', 'hsl(var(--status-warning))'];
      ...
      <CardContent className="p-3 sm:p-4 pt-0">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <div className="space-y-2">
            <h4 className="text-xs sm:text-sm font-medium text-center text-emerald-600">
              الإيرادات
            </h4>
          ...
          {/* دائرة المصروفات */}
          <div className="space-y-2">
            <h4 className="text-xs sm:text-sm font-medium text-center text-destructive">
              المصروفات
            </h4>
          ...
          <div className="space-y-2">
            <h4 className="text-xs sm:text-sm font-medium text-center text-amber-600">
              توزيعات الورثة
            </h4>
            <ResponsiveContainer width="100%" height={180}>
