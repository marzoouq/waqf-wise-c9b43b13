...
const ALL_SERVICES = [
  ...
  { name: 'archive.service', table: 'archived_documents', description: 'خدمة الأرشيف' },
  ...
  { name: 'contract.service', table: 'rental_contracts', description: 'خدمة العقود' },
  ...
  { name: 'historical-rental.service', table: 'historical_rentals', description: 'خدمة الإيجارات التاريخية' },
  { name: 'integration.service', table: 'integrations', description: 'خدمة التكاملات' },
  ...
  { name: 'security.service', table: 'login_attempts', description: 'خدمة الأمان' },
  { name: 'settings.service', table: 'system_settings', description: 'خدمة الإعدادات' },
  ...
  { name: 'system.service', table: 'system_health', description: 'خدمة النظام' },
