...
export const commonValidation = {
  requiredString: (msg: string) => z.string().min(1, { message: msg }),
  ...
  date: (msg: string) => z.date({ required_error: msg }),
  ...
  positiveInteger: (msg: string) => z.number().int().positive({ message: msg }),
};
