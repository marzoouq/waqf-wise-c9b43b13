...
export const VERSION_INFO = {
  ...
  features: [
    'تحويل نظام نقطة البيع إلى مركز التحصيل والصرف',
    'إزالة مفهوم الرصيد الافتتاحي والختامي والفروقات',
    'تبسيط فتح/إنهاء جلسات العمل بنقرة واحدة',
    'التركيز على العمليات الفعلية (تحصيل/صرف)',
    'واجهة متوافقة مع إدارة العقارات والوقف',
  ],
} as const;
