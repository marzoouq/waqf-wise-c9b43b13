...
export const BeneficiaryAccountStatement = lazyWithRetry(
  () => import('@/pages/BeneficiaryAccountStatement')
);
...
export const GovernanceBoards = lazyWithRetry(() => import('@/pages/GovernanceBoards'));
export const GovernancePolicies = lazyWithRetry(() => import('@/pages/GovernancePolicies'));
...
export const DatabasePerformanceDashboard = lazyWithRetry(
  () => import('@/pages/DatabasePerformanceDashboard')
);
export const DatabaseHealthDashboard = lazyWithRetry(
  () => import('@/pages/DatabaseHealthDashboard')
);
