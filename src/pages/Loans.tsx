            ...
            <div className="flex gap-2">
              <Button
                ...
                onClick={async () => {
                  ...
                  await exportToExcel(
                    exportData,
                    `قروض_${format(new Date(), 'yyyy-MM-dd')}`,
                    'القروض'
                  );
                }}
                className="gap-1"
                        ...
                        <div className="grid grid-cols-2 gap-2 text-sm">
                          <div>
                            ...
                            <p className="font-semibold">
                              {loan.loan_amount.toLocaleString('ar-SA')} ر.س
                            </p>
                          </div>
                          <div>
                            <p className="text-muted-foreground text-xs">القسط الشهري</p>
                            <p className="font-semibold text-primary">
                              {loan.monthly_installment.toLocaleString('ar-SA')} ر.س
                            </p>
                          </div>
                          <div>
                        ...
                        {filteredLoans.map((loan: Loan) => (
                          <TableRow key={loan.id} className="hover:bg-muted/50">
                            ...
                            <TableCell className="text-xs sm:text-sm">
                              <div>
                                <div className="font-medium">{loan.beneficiary?.full_name}</div>
