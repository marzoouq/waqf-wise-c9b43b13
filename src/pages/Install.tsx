      ...
      <main className="container max-w-4xl mx-auto px-3 py-4 sm:px-4 sm:py-5 md:px-6 md:py-6 lg:px-8 lg:py-8 space-y-4 sm:space-y-5 md:space-y-6 overflow-x-hidden">
        <Card>
          <CardHeader>
            ...
            <CardDescription>استمتع بتجربة أفضل مع التطبيق المثبت على جهازك</CardDescription>
          </CardHeader>
              ...
              <>
                <div className="grid md:grid-cols-3 gap-4">
                  <div className="text-center p-4 border rounded-lg">
                    ...
                    <p className="text-sm text-muted-foreground">استخدم التطبيق حتى بدون اتصال</p>
                  </div>
                  <div className="text-center p-4 border rounded-lg">
                    <Download className="w-12 h-12 mx-auto mb-2 text-primary" />
                    <h3 className="font-semibold mb-1">سرعة فائقة</h3>
                    <p className="text-sm text-muted-foreground">تحميل فوري وأداء ممتاز</p>
                  </div>
                  <div className="text-center p-4 border rounded-lg">
                    <Globe className="w-12 h-12 mx-auto mb-2 text-primary" />
                    <h3 className="font-semibold mb-1">تجربة أصلية</h3>
                    <p className="text-sm text-muted-foreground">يظهر مثل التطبيقات العادية</p>
                  </div>
                </div>
