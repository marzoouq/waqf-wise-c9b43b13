...
export default function ConnectionDiagnostics() {
  ...
  const runDiagnostics = async () => {
    ...
    for (let i = 0; i < diagnosticTests.length; i++) {
      ...
      setTests((prev) => prev.map((t) => (t.id === test.id ? { ...t, ...result, duration } : t)));
          ...
          <TabsContent value="diagnostics" className="space-y-4">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>اختبار جميع مكونات الاتصال للكشف عن المشاكل</CardDescription>
              </CardHeader>
              ...
              <CardContent>
                <div className="space-y-3">
                  ...
                  {Object.keys(stats.eventsByType).length === 0 && (
                    <p className="text-center text-muted-foreground py-4">لا توجد أحداث مسجلة</p>
                  )}
                </div>
              </CardContent>
            </Card>
