    ...
    functions: [
      {
        ...
        defaultBody: { auditType: 'full', categories: ['database', 'tables', 'roles'] },
      },
      {
        name: 'chatbot',
        description: 'المساعد الذكي',
        defaultBody: { message: 'مرحباً، كيف يمكنني المساعدة؟' },
      },
      {
        name: 'generate-ai-insights',
        description: 'توليد الرؤى الذكية',
        defaultBody: { reportType: 'beneficiaries' },
      },
      {
        name: 'intelligent-search',
        description: 'البحث الذكي',
        defaultBody: { query: 'بحث تجريبي', type: 'beneficiaries' },
      },
      {
  ...
  database: {
    ...
    functions: [
      { name: 'db-health-check', description: 'فحص صحة قاعدة البيانات', defaultBody: {} },
      {
        ...
        description: 'إحصائيات أداء قاعدة البيانات',
        defaultBody: {},
      },
      { name: 'run-vacuum', description: 'تنظيف قاعدة البيانات', defaultBody: {} },
      {
        ...
        defaultBody: { backupType: 'full' },
      },
      {
        name: 'restore-database',
        description: 'استعادة النسخة الاحتياطية',
        defaultBody: { testMode: true },
      },
    ],
  },
  security: {
    ...
    functions: [
      ...
      { name: 'decrypt-file', description: 'فك تشفير الملفات', defaultBody: { ping: true } },
      {
        ...
        defaultBody: { testMode: true, fileId: 'test-file-id' },
      },
      {
        name: 'check-leaked-password',
        description: 'فحص كلمات المرور المسربة',
        defaultBody: { password: 'test123' },
      },
      {
        name: 'biometric-auth',
    ...
    functions: [
      {
        ...
        defaultBody: { userId: 'test', title: 'اختبار', message: 'رسالة اختبار' },
      },
      {
        name: 'send-push-notification',
        description: 'إشعار الدفع',
        defaultBody: { userId: 'test', title: 'اختبار', body: 'رسالة اختبار للإشعارات' },
      },
      { name: 'daily-notifications', description: 'الإشعارات اليومية', defaultBody: {} },
      {
        name: 'notify-admins',
        description: 'إشعار المديرين',
        defaultBody: { title: 'تنبيه اختباري', message: 'رسالة اختبار للمديرين', severity: 'info' },
      },
      {
      ...
      },
      {
        ...
        defaultBody: { message: 'اختبار', severity: 'info' },
      },
  ...
  finance: {
    ...
    functions: [
      ...
      },
      {
        ...
        defaultBody: { amount: 1000 },
      },
      {
        name: 'auto-create-journal',
        description: 'إنشاء قيد آلي',
        defaultBody: {
      ...
      },
      {
        ...
        description: 'حساب التدفقات النقدية',
        defaultBody: { period: 'monthly' },
      },
      {
        name: 'link-voucher-journal',
        description: 'ربط السند بالقيد',
        defaultBody: { voucher_id: 'test-voucher-id', create_journal: false },
      },
      {
        name: 'publish-fiscal-year',
        description: 'نشر السنة المالية',
        defaultBody: { fiscalYearId: 'test-fiscal-year-id', notifyHeirs: false },
      },
      {
        name: 'auto-close-fiscal-year',
        description: 'إقفال السنة المالية',
        defaultBody: { testMode: true },
      },
      {
        name: 'zatca-submit',
        description: 'إرسال لزاتكا',
        defaultBody: {
          testMode: true,
  ...
  documents: {
    ...
    functions: [
      { name: 'ocr-document', description: 'قراءة المستندات OCR', defaultBody: { ping: true } },
      {
        ...
        defaultBody: { ping: true },
      },
      {
        name: 'auto-classify-document',
        description: 'تصنيف المستندات',
        defaultBody: { documentId: 'test-document-id', useAI: false },
      },
      {
        name: 'backfill-rental-documents',
        description: 'استكمال مستندات الإيجار',
        defaultBody: {},
      },
      {
        name: 'send-invoice-email',
        description: 'إرسال الفاتورة بالبريد',
        defaultBody: {
          testMode: true,
          invoiceId: 'test',
    ...
    functions: [
      {
        ...
        defaultBody: { beneficiaryIds: [] },
      },
      {
        name: 'admin-manage-beneficiary-password',
        description: 'إدارة كلمة مرور المستفيد',
        defaultBody: {
      ...
      },
      {
        ...
        defaultBody: { user_id: 'test-user-id', new_password: 'Test@123456' },
      },
      {
        name: 'update-user-email',
        description: 'تحديث البريد الإلكتروني',
        defaultBody: { userId: 'test-user-id', newEmail: 'test@test.com' },
      },
    ],
  },
  maintenance: {
    ...
    functions: [
      {
        ...
        description: 'توليد تقرير مجدول',
        defaultBody: { reportType: 'monthly' },
      },
      { name: 'weekly-report', description: 'التقرير الأسبوعي', defaultBody: {} },
      {
        name: 'generate-distribution-summary',
        description: 'ملخص التوزيعات',
        defaultBody: {
          period_start: '2024-01-01',
          period_end: '2024-12-31',
          distribution_type: 'سنوي',
        },
      },
    ],
  },
  support: {
    ...
    functions: [
      { name: 'support-auto-escalate', description: 'التصعيد التلقائي للدعم', defaultBody: {} },
      {
        ...
        defaultBody: { error: 'test error', source: 'test' },
      },
      {
        name: 'test-auth',
        description: 'اختبار المصادقة',
        defaultBody: { action: 'health-check' },
      },
    ],
  },
};
...
// حساب إجمالي الوظائف
const ALL_FUNCTIONS: EdgeFunctionDef[] = Object.values(EDGE_FUNCTIONS_BY_CATEGORY).flatMap(
  (cat) => cat.functions
);
  ...
  const handleBatchTest = async () => {
    const functionsToTest =
      selectedCategory === 'all'
        ? ALL_FUNCTIONS
        : EDGE_FUNCTIONS_BY_CATEGORY[selectedCategory as keyof typeof EDGE_FUNCTIONS_BY_CATEGORY]
            ?.functions || [];
  ...
  const exportResults = () => {
    const report = {
      ...
      avgResponseTime: Math.round(
        batchResults.reduce((acc, r) => acc + r.responseTime, 0) / batchResults.length
      ),
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <SelectContent>
                        {(selectedCategory === 'all'
                          ? ALL_FUNCTIONS
                          : EDGE_FUNCTIONS_BY_CATEGORY[
                              selectedCategory as keyof typeof EDGE_FUNCTIONS_BY_CATEGORY
                            ]?.functions || []
                        ).map((func) => (
                ...
                <CardContent>
                  {!result ? (
                    ...
                    <div className="space-y-4">
                      <div
                        className={`p-4 rounded-lg ${result.success ? 'bg-green-500/10 border border-green-500/20' : 'bg-destructive/10 border border-destructive/20'}`}
                      >
              ...
              <CardContent className="space-y-6">
                <div className="flex items-center gap-4">
                  <Select value={selectedCategory} onValueChange={setSelectedCategory}>
                    ...
                    <SelectContent>
                      <SelectItem value="all">جميع الفئات ({TOTAL_FUNCTIONS} وظيفة)</SelectItem>
                      {Object.entries(EDGE_FUNCTIONS_BY_CATEGORY).map(([key, cat]) => (
                        <SelectItem key={key} value={key}>
                          <span className="flex items-center gap-2">
                            <cat.icon className={`h-4 w-4 ${cat.color}`} />
                ...
                {batchProgress && (
                  <div className="space-y-2">
                    <div className="flex items-center justify-between text-sm">
                      <span>
                        التقدم: {batchProgress.completed}/{batchProgress.total}
                      </span>
                          ...
                          <AccordionContent>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-2 pt-2">
                              {cat.functions.map((func) => {
                                const funcResult = batchResults.find(
                                      ...
                                      {funcResult ? (
                                        <>
                                          ...
                                          <Badge variant="outline">
                                            {funcResult.responseTime}ms
                                          </Badge>
                                        </>
                                      ) : isBatchTesting &&
                                        batchProgress?.currentFunction === func.name ? (
                      ...
                      <Card className="bg-blue-500/10">
                        <CardContent className="p-4 text-center">
                          <div className="text-3xl font-bold text-blue-500">
                            {Math.round(
                              batchResults.reduce((acc, r) => acc + r.responseTime, 0) /
                                batchResults.length
                            )}
                            ms
                          </div>
