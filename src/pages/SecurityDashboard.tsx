...
export default function SecurityDashboard() {
  ...
  const handleExportPDF = () => {
    try {
      ...
      doc.text(
        `Total Events: ${stats.total} | Warnings: ${stats.warning} | Errors: ${stats.error}`,
        14,
        28
      );
  ...
  const eventsColumns: Column<SecurityEvent>[] = [
    ...
    },
    {
      ...
      render: (value: boolean) =>
        value ? <Badge variant="secondary">تم الحل</Badge> : <Badge variant="outline">معلق</Badge>,
    },
    {
      key: 'created_at',
      label: 'التاريخ',
  ...
  const sessionsColumns: Column<ActiveSession>[] = [
    ...
    },
    {
      ...
      label: 'آخر نشاط',
      render: (value: string) =>
        value ? format(new Date(value), 'dd/MM/yyyy HH:mm', { locale: ar }) : '-',
    },
    {
      key: 'created_at',
      label: 'تاريخ الإنشاء',
  ...
  const attemptsColumns: Column<LoginAttempt>[] = [
    ...
    },
    {
      ...
      label: 'الحالة',
      render: (value: boolean) =>
        value ? <Badge variant="secondary">ناجح</Badge> : <Badge variant="destructive">فاشل</Badge>,
    },
    {
      key: 'ip_address',
      label: 'عنوان IP',
