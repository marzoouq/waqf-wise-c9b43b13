...
const criticalStyles = {
  ...
  input:
    'w-full px-3 py-2 border border-input rounded-lg bg-background text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:border-transparent',
  button:
    'w-full py-2.5 px-4 bg-primary text-primary-foreground rounded-lg font-medium hover:bg-primary/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2',
  buttonOutline:
    'w-full py-2.5 px-4 border border-input bg-background text-foreground rounded-lg font-medium hover:bg-accent hover:text-accent-foreground transition-colors disabled:opacity-50 flex items-center justify-center gap-2',
    ...
    <div className={criticalStyles.container}>
      <main>
        <div className={criticalStyles.card}>
          ...
          {/* Error Message */}
          {error && <div className={criticalStyles.error}>{error}</div>}
          ...
          <form onSubmit={handleSubmit} className="space-y-4 mt-4">
            ...
            <button type="submit" disabled={isLoading} className={criticalStyles.button}>
              {isLoading ? (
                <>
          ...
          <div className="text-center text-sm text-muted-foreground mt-6 space-y-2">
            ...
            <div className="flex flex-col gap-2">
              ...
              <Link
                to="/install"
                className={`${criticalStyles.link} text-muted-foreground hover:text-primary`}
              >
                <Icons.Smartphone />
