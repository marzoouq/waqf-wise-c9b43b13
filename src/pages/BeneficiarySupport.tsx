                ...
                <CardContent className="p-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <a
                        href="tel:+966533030345"
                        className="text-sm font-medium mt-1 block hover:text-primary transition-colors"
                        dir="ltr"
                      >
                        0533030345
                      </a>
                    ...
                    <form onSubmit={handleSubmitSupportTicket} className="space-y-4">
                      ...
                      <div className="bg-muted p-4 rounded-lg">
                        <p className="text-sm text-muted-foreground">
                          <strong>ملاحظة:</strong> سيتم الرد على رسالتك خلال 24-48 ساعة عمل. للحالات
                          العاجلة، يرجى الاتصال بنا هاتفياً.
                        </p>
                      </div>
