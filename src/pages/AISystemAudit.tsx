...
export default function AISystemAudit() {
  ...
  const handleRunAudit = () => {
    runAudit(
      selectedCategories.length > 0 ? 'category' : 'full',
      ...
      <MobileOptimizedLayout>
        ...
        <div className="space-y-6">
          ...
          <Tabs defaultValue="pending" className="space-y-4">
            <TabsList>
              <TabsTrigger value="pending">الإصلاحات المعلقة ({pendingFixes.length})</TabsTrigger>
                            ...
                            <div className="flex items-center justify-between mb-3">
                              <div className="flex items-center gap-2">
                                <Badge variant="outline">
                                  {audit.audit_type === 'full' ? 'فحص شامل' : 'فحص جزئي'}
                                </Badge>
                            ...
                            <div className="flex gap-4">
                              <div className="flex items-center gap-1">
                                ...
                                <span className="text-sm">
                                  {audit.severity_summary?.critical || 0} حرج
                                </span>
                              </div>
                              <div className="flex items-center gap-1">
                                <AlertTriangle className="h-4 w-4 text-yellow-500" />
                                <span className="text-sm">
                                  {audit.severity_summary?.warning || 0} تحذير
                                </span>
                              </div>
                              <div className="flex items-center gap-1">
                                <CheckCircle className="h-4 w-4 text-green-500" />
                                <span className="text-sm">
                                  {audit.severity_summary?.success || 0} سليم
                                </span>
                              </div>
                            </div>
                          </div>
