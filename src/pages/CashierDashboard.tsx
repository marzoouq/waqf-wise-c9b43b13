  ...
  if (error) {
    return (
      <ErrorState
        ...
        message="فشل تحميل بيانات أمين الصندوق"
        onRetry={refetch}
      />
    );
  }
              ...
              <div className="space-y-4">
                ...
                <div className="border-t pt-3">
                  <div className="flex justify-between items-center">
                    ...
                    >
                      {((stats?.todayReceipts || 0) - (stats?.todayPayments || 0)).toLocaleString(
                        'ar-SA'
                      )}{' '}
                      ريال
                    </span>
        ...
        <TabsContent value="actions" className="space-y-4">
          <div className="grid gap-4 grid-cols-1 sm:grid-cols-2">
            ...
            >
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">تسجيل مقبوضات نقدية أو بنكية جديدة</p>
            ...
            >
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">تسجيل مدفوعات نقدية أو بنكية جديدة</p>
