    ...
    <MobileOptimizedLayout>
      ...
      <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full">
        <TabsList className="grid w-full grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 h-auto gap-1">
          ...
          <TabsTrigger value="trial-balance" className="flex items-center gap-1 sm:gap-2 text-xs sm:text-sm py-2" title="Alt+3">
            <FileSpreadsheet className="h-3 w-3 sm:h-4 sm:w-4" />
            <span className="hidden lg:inline">ميزان المراجعة</span>
            <span className="lg:hidden">الميزان</span>
          </TabsTrigger>
          <TabsTrigger value="ledger" className="flex items-center gap-1 sm:gap-2 text-xs sm:text-sm py-2" title="Alt+4">
            <FileText className="h-3 w-3 sm:h-4 sm:w-4" />
            <span className="hidden lg:inline">دفتر الأستاذ</span>
            <span className="lg:hidden">الأستاذ</span>
          </TabsTrigger>
          <TabsTrigger value="bank-accounts" className="flex items-center gap-1 sm:gap-2 text-xs sm:text-sm py-2" title="Alt+5">
            <Wallet className="h-3 w-3 sm:h-4 sm:w-4" />
            <span className="hidden lg:inline">الحسابات البنكية</span>
            <span className="lg:hidden">البنوك</span>
          </TabsTrigger>
          <TabsTrigger value="cash-flow" className="flex items-center gap-1 sm:gap-2 text-xs sm:text-sm py-2" title="Alt+6">
