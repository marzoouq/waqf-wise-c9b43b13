...
export default function BankTransfers() {
  ...
  const handleExport = () => {
    ...
    const records: BankTransferRecord[] = (
      (distribution.distribution_details || []) as DistributionDetail[]
    ).map((detail) => ({
  ...
  if (error) {
    return (
      <ErrorState
        ...
        message="فشل تحميل بيانات التوزيعات"
                ...
                <div className="flex gap-3">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      مدعوم من معظم البنوك المحلية (الراجحي، الأهلي، الرياض). ملف نصي بسيط يمكن فتحه
                      بـ Excel.
                    </p>
                  </div>
                </div>
