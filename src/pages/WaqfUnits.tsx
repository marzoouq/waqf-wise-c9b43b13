...
export default function WaqfUnits() {
  ...
  const filteredUnits = waqfUnits.filter((unit) => {
    ...
    const matchesActive =
      advancedFilters.is_active === undefined ||
  ...
  const { selectedCount, isSelected, isAllSelected, toggleSelection, toggleAll, clearSelection } =
      ...
      <MobileOptimizedLayout>
              ...
              {filteredUnits.length > 0 && (
                <ExportButton
                  data={filteredUnits.map((u) => ({
                    ...
                    'تاريخ الاستحواذ': u.acquisition_date
                      ? format(new Date(u.acquisition_date), 'dd/MM/yyyy')
                      : '-',
                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead className="text-start whitespace-nowrap hidden lg:table-cell">
                        الموقع
                      </TableHead>
                      <SortableTableHeader
                        label="الرصيد"
                  ...
                  <TableBody>
                    {sortedData.map((unit) => (
                      <TableRow key={unit.id}>
                        ...
                        <TableCell>
                          <Badge
                            variant={unit.is_active ? 'outline' : 'secondary'}
        ...
        <WaqfUnitDetailsDialog
          ...
          selectedFiscalYearId={
            selectedFiscalYear !== 'all' ? selectedFiscalYear : activeFiscalYear?.id
          }
        />
