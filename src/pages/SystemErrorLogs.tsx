...
export default function SystemErrorLogs() {
  ...
  return (
    <PageErrorBoundary pageName="سجلات الأخطاء">
      <div className="container mx-auto px-3 py-4 sm:px-4 sm:py-5 md:px-6 md:py-6 lg:px-8 lg:py-8 space-y-4 sm:space-y-5 md:space-y-6 w-full max-w-full overflow-x-hidden">
        <div>
            ...
            <Tabs defaultValue="all">
              <TabsList>
                ...
                <TabsTrigger value="investigating">
                  قيد المعالجة ({stats.investigating})
                </TabsTrigger>
                        ...
                        <Dialog key={log.id}>
                          ...
                          <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto">
                            <DialogHeader>
                              ...
                              <DialogDescription>إدارة ومعالجة الخطأ</DialogDescription>
                            </DialogHeader>
