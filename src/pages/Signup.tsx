...
export default function Signup() {
  ...
  return (
    <div
      className="min-h-screen bg-gradient-to-br from-background via-background to-accent/20 flex items-center justify-center p-4 overflow-x-hidden"
      dir="rtl"
    >
      <Card className="w-full max-w-md">
        <CardHeader className="text-center pb-2">
          ...
          <CardDescription>التسجيل الذاتي معطل في هذا النظام</CardDescription>
        </CardHeader>
        ...
        <CardContent className="space-y-4">
          <Alert>
            ...
            <AlertDescription>
              يتم إنشاء الحسابات فقط من قبل الناظر أو المشرف المسؤول عن النظام. إذا كنت مستفيداً أو
              ورثة للوقف، يرجى التواصل مع الناظر للحصول على بيانات الدخول.
            </AlertDescription>
          </Alert>
