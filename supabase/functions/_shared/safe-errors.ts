...
export function getSafeErrorMessage(error: unknown): string {
  if (error instanceof Error) {
    ...
    if (error.message.includes('مصادقة') || error.message.includes('authentication')) {
...
export function logAndReturnSafeError(error: unknown, context: string, userId?: string): Response {
