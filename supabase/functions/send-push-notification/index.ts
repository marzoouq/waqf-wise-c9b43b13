...
serve(async (req) => {
  ...
  try {
    ...
    const _icon = bodyData._icon as string | undefined;
    const _badge = bodyData._badge as string | undefined;
    const _data = bodyData._data as Record<string, unknown> | undefined;
