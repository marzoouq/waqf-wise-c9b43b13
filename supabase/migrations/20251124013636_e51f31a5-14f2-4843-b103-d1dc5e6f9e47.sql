...
-- إصلاح trigger المدفوعات - إضافة line_number
...
BEGIN
  ...
  VALUES (v_entry_id, v_debit_account_id, NEW.amount, 0, NEW.description, 1);

  -- إضافة سطور القيد (دائن)
  INSERT INTO journal_entry_lines (journal_entry_id, account_id, debit_amount, credit_amount, description, line_number)
  VALUES (v_entry_id, v_credit_account_id, 0, NEW.amount, NEW.description, 2);
